...
class DES extends BlockCipher {
	 ...
	 * @access private
	 */
	protected $openssl_mode_names = array(
	 ...
	 * @access private
	 */
	protected static $invipmap = array(
		0x00,
		0x80,
		0x40,
		0xC0,
