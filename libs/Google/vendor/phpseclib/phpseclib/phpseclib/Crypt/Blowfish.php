...
class Blowfish extends BlockCipher {
	...
	protected function encryptBlock( $in ) {
		...
		for ( $i = 0; $i < 16; $i += 2 ) {
			$l ^= $p[ $i ];
			$r ^= self::safe_intval(
				( self::safe_intval( $sb_0[ $l >> 24 & 0xff ] + $sb_1[ $l >> 16 & 0xff ] ) ^
				  $sb_2[ $l >> 8 & 0xff ] ) +
				  $sb_3[ $l & 0xff ]
			);
			...
			$r ^= $p[ $i + 1 ];
			$l ^= self::safe_intval(
				( self::safe_intval( $sb_0[ $r >> 24 & 0xff ] + $sb_1[ $r >> 16 & 0xff ] ) ^
				  $sb_2[ $r >> 8 & 0xff ] ) +
				  $sb_3[ $r & 0xff ]
			);
		}
