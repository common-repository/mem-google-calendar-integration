...
class Events extends \Google\Service\Resource {
	...
	public function get( $calendarId, $eventId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), Event::class );
	}
	/**
	...
	public function import( $calendarId, Event $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'import', array( $params ), Event::class );
	}
	/**
	...
	public function insert( $calendarId, Event $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), Event::class );
	}
	/**
	...
	public function instances( $calendarId, $eventId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'instances', array( $params ), EventsModel::class );
	}
	/**
	...
	public function listEvents( $calendarId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), EventsModel::class );
	}
	/**
	...
	public function move( $calendarId, $eventId, $destination, $optParams = array() ) {
		 ...
		 $params = array_merge( $params, $optParams );
		 return $this->call( 'move', array( $params ), Event::class );
	}
	/**
	...
	public function patch( $calendarId, $eventId, Event $postBody, $optParams = array() ) {
		 ...
		 $params = array_merge( $params, $optParams );
		 return $this->call( 'patch', array( $params ), Event::class );
	}
	/**
	...
	public function quickAdd( $calendarId, $text, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'quickAdd', array( $params ), Event::class );
	}
	/**
	...
	public function update( $calendarId, $eventId, Event $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), Event::class );
	}
	/**
	...
	public function watch( $calendarId, Channel $postBody, $optParams = array() ) {
		 ...
		 $params = array_merge( $params, $optParams );
		 return $this->call( 'watch', array( $params ), Channel::class );
	}
}
