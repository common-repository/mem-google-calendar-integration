...
class Calendars extends \Google\Service\Resource {
	...
	public function get( $calendarId, $optParams = array() ) {
		$params = array( 'calendarId' => $calendarId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), Calendar::class );
	}
	/**
	...
	public function insert( Calendar $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), Calendar::class );
	}
	/**
	...
	public function patch( $calendarId, Calendar $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), Calendar::class );
	}
	/**
	...
	public function update( $calendarId, Calendar $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), Calendar::class );
	}
}
