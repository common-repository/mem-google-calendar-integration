...
class CalendarList extends \Google\Service\Resource {
	...
	public function get( $calendarId, $optParams = array() ) {
		$params = array( 'calendarId' => $calendarId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), CalendarListEntry::class );
	}
	/**
	...
	public function insert( CalendarListEntry $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), CalendarListEntry::class );
	}
	/**
	...
	public function listCalendarList( $optParams = array() ) {
		$params = array();
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), CalendarListModel::class );
	}
	/**
	...
	public function patch( $calendarId, CalendarListEntry $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), CalendarListEntry::class );
	}
	/**
	...
	public function update( $calendarId, CalendarListEntry $postBody, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), CalendarListEntry::class );
	}
	/**
